...
:::{.callout-caution}
## Does ThGAT create an infinite regress?

ThGAT is a model of itself, which sounds circular. The circularity is broken by Level 0: the GAT engine is hardcoded Rust, not data. ThGAT describes what a theory *is*, but the engine that *interprets* ThGAT is outside the self-description loop.
:::
