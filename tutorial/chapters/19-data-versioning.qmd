...
Schemas evolve. Data does not evolve on its own. Every time you commit a schema version, the records written against a previous version fall out of sync. panproto versions both schemas and data, keeping them aligned through the commit DAG. This chapter covers the data versioning system that closes that gap.
