...
pub use api::{
    ...
    define_protocol, diff_schemas, diff_schemas_full, emit_instance, eval_func_expr,
    execute_query, factorize_morphism, free_handle, get_builtin_protocol, get_dataset,
    ...
    migrate_model, normalize_schema, parse_expr, parse_instance, protolens_chain_to_json,
