...
///
/// JSON Schema shares the constrained-multigraph schema theory and
/// W-type instance theory with `ATProto`, `bson`, and `cddl`, so it
/// registers through the shared helper rather than composing the
/// colimit by hand.
