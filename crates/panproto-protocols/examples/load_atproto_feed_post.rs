...
const LEXICONS: &[(&str, &str)] = &[
    ...
    ("app.bsky.feed.repost", include_str!("../../../fixtures/atproto/lexicons/app.bsky.feed.repost.json")),
    ("app.bsky.graph.follow", include_str!("../../../fixtures/atproto/lexicons/app.bsky.graph.follow.json")),
    ("com.atproto.repo.createRecord", include_str!("../../../fixtures/atproto/lexicons/com.atproto.repo.createRecord.json")),
];
