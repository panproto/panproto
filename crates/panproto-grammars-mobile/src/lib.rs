//! Companion grammar package: mobile languages.
//!
//! pyo3 cdylib that bakes the `panproto-grammars` `group-mobile`
//! feature (Swift, Kotlin, Dart, Java, Objective-C)
...
#[pymodule(name = "_impl")]
fn panproto_grammars_mobile_impl(m: &Bound<'_, PyModule>) -> PyResult<()> {
