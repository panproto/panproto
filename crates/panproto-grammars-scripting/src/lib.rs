//! Companion grammar package: scripting languages.
//!
//! pyo3 cdylib that bakes the `panproto-grammars` `group-scripting`
//! feature (Python, Ruby, Lua, Bash, Perl, R, Julia, Nushell, Fish)
...
#[pymodule(name = "_impl")]
fn panproto_grammars_scripting_impl(m: &Bound<'_, PyModule>) -> PyResult<()> {
