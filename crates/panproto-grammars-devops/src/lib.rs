//! Companion grammar package: devops languages.
//!
//! pyo3 cdylib that bakes the `panproto-grammars` `group-devops`
//! feature (Dockerfile, Terraform, HCL, Nix, Bash, YAML, TOML, Make, CMake)
...
#[pymodule(name = "_impl")]
fn panproto_grammars_devops_impl(m: &Bound<'_, PyModule>) -> PyResult<()> {
