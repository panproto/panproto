//! Companion grammar package: systems languages.
//!
//! pyo3 cdylib that bakes the `panproto-grammars` `group-systems`
//! feature (C, C++, Rust, Go, Zig, D, Nim, Odin, V, Hare)
...
#[pymodule(name = "_impl")]
fn panproto_grammars_systems_impl(m: &Bound<'_, PyModule>) -> PyResult<()> {
