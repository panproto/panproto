...
[![PyPI](https://img.shields.io/pypi/v/panproto-grammars-systems)](https://pypi.org/project/panproto-grammars-systems/)
[![Python](https://img.shields.io/pypi/pyversions/panproto-grammars-systems)](https://pypi.org/project/panproto-grammars-systems/)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/panproto/panproto/blob/main/LICENSE)

Companion grammar pack for [panproto] shipping tree-sitter grammars for systems-language source: C, C++, Rust, Go, Zig, D, Nim, Odin, V, and Hare.
...
Pre-1.0 with arbitrary breaking changes between minor versions. The pack version tracks the workspace `panproto` version on every release; consumers should pin both to the same minor (e.g. `panproto>=0.45,<0.46` and `panproto-grammars-systems>=0.45,<0.46`).
...
Source: [`crates/panproto-grammars-systems`](https://github.com/panproto/panproto/tree/main/crates/panproto-grammars-systems) on the Rust side, [`bindings/python-grammars-systems`](https://github.com/panproto/panproto/tree/main/bindings/python-grammars-systems) on the Python side.
