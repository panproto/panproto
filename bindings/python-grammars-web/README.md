...
[![PyPI](https://img.shields.io/pypi/v/panproto-grammars-web)](https://pypi.org/project/panproto-grammars-web/)
[![Python](https://img.shields.io/pypi/pyversions/panproto-grammars-web)](https://pypi.org/project/panproto-grammars-web/)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/panproto/panproto/blob/main/LICENSE)

Companion grammar pack for [panproto] shipping tree-sitter grammars for web-language source: HTML, CSS, JavaScript, TypeScript, TSX, JSON, Vue, Svelte, Astro, and GraphQL.
...
Pre-1.0 with arbitrary breaking changes between minor versions. The pack version tracks the workspace `panproto` version on every release; consumers should pin both to the same minor (e.g. `panproto>=0.45,<0.46` and `panproto-grammars-web>=0.45,<0.46`).
...
Source: [`crates/panproto-grammars-web`](https://github.com/panproto/panproto/tree/main/crates/panproto-grammars-web) on the Rust side, [`bindings/python-grammars-web`](https://github.com/panproto/panproto/tree/main/bindings/python-grammars-web) on the Python side.
