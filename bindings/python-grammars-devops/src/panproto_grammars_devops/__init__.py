"""panproto grammar pack: devops languages.

Companion package to panproto. Brings tree-sitter grammars for
Dockerfile, Terraform, HCL, Nix, Bash, YAML, TOML, Make, CMake into ``panproto.AstParserRegistry`` via the
...
try:
    __version__ = _pkg_version("panproto-grammars-devops")
