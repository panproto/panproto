...
[![PyPI](https://img.shields.io/pypi/v/panproto-grammars-all)](https://pypi.org/project/panproto-grammars-all/)
[![Python](https://img.shields.io/pypi/pyversions/panproto-grammars-all)](https://pypi.org/project/panproto-grammars-all/)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/panproto/panproto/blob/main/LICENSE)

Companion grammar pack for [panproto] shipping tree-sitter grammars for all-language source: every tree-sitter grammar bundled in panproto-grammars (around 250 languages).
...
Pre-1.0 with arbitrary breaking changes between minor versions. The pack version tracks the workspace `panproto` version on every release; consumers should pin both to the same minor (e.g. `panproto>=0.45,<0.46` and `panproto-grammars-all>=0.45,<0.46`).
...
Source: [`crates/panproto-grammars-all`](https://github.com/panproto/panproto/tree/main/crates/panproto-grammars-all) on the Rust side, [`bindings/python-grammars-all`](https://github.com/panproto/panproto/tree/main/bindings/python-grammars-all) on the Python side.
