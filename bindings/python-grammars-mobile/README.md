...
[![PyPI](https://img.shields.io/pypi/v/panproto-grammars-mobile)](https://pypi.org/project/panproto-grammars-mobile/)
[![Python](https://img.shields.io/pypi/pyversions/panproto-grammars-mobile)](https://pypi.org/project/panproto-grammars-mobile/)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/panproto/panproto/blob/main/LICENSE)

Companion grammar pack for [panproto] shipping tree-sitter grammars for mobile-language source: Swift, Kotlin, Dart, Java, and Objective-C.
...
Pre-1.0 with arbitrary breaking changes between minor versions. The pack version tracks the workspace `panproto` version on every release; consumers should pin both to the same minor (e.g. `panproto>=0.45,<0.46` and `panproto-grammars-mobile>=0.45,<0.46`).
...
Source: [`crates/panproto-grammars-mobile`](https://github.com/panproto/panproto/tree/main/crates/panproto-grammars-mobile) on the Rust side, [`bindings/python-grammars-mobile`](https://github.com/panproto/panproto/tree/main/bindings/python-grammars-mobile) on the Python side.
