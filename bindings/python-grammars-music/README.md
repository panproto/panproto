...
[![PyPI](https://img.shields.io/pypi/v/panproto-grammars-music)](https://pypi.org/project/panproto-grammars-music/)
[![Python](https://img.shields.io/pypi/pyversions/panproto-grammars-music)](https://pypi.org/project/panproto-grammars-music/)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/panproto/panproto/blob/main/LICENSE)

Companion grammar pack for [panproto] shipping tree-sitter grammars for music-language source: SuperCollider, LilyPond, ABC, Csound, ChucK, Glicol, Tidal mini-notation, and Strudel mini-notation.
...
Pre-1.0 with arbitrary breaking changes between minor versions. The pack version tracks the workspace `panproto` version on every release; consumers should pin both to the same minor (e.g. `panproto>=0.45,<0.46` and `panproto-grammars-music>=0.45,<0.46`).
...
Source: [`crates/panproto-grammars-music`](https://github.com/panproto/panproto/tree/main/crates/panproto-grammars-music) on the Rust side, [`bindings/python-grammars-music`](https://github.com/panproto/panproto/tree/main/bindings/python-grammars-music) on the Python side.
