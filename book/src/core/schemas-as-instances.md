...
A protocol describes a class of schemas. The theory says what sorts a schema under this protocol has available, what operations it may invoke, and what equations those operations must satisfy. A schema fixes choices within that frame, and nothing more.
