...
Every optimization preserves correctness. Formal proofs are provided in [Appendix E of the tutorial](https://panproto.github.io/tutorial/appendices/E-formal-proofs.html).
...
**Location:** `crates/panproto-inst/src/wtype.rs`, in `contract_ancestors()`.
